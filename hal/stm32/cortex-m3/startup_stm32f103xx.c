...
/* IRQs shared by all density tiers (IRQ0–IRQ22) */
...
/* LD / MD only (no TIM4, no USB, no CAN on LD) */
#if defined(DENSITY_LD) || defined(DENSITY_MD)
...
void CAN_RX1_IRQHandler(void)          __attribute__((weak, alias("Default_Handler")));
void CAN_SCE_IRQHandler(void)          __attribute__((weak, alias("Default_Handler")));
/* IRQ24–26: TIM1 slots share TIM9/10/11 on XL */
void TIM1_BRK_TIM9_IRQHandler(void)    __attribute__((weak, alias("Default_Handler")));
void TIM1_UP_TIM10_IRQHandler(void)    __attribute__((weak, alias("Default_Handler")));
void TIM1_TRG_COM_TIM11_IRQHandler(void)__attribute__((weak, alias("Default_Handler")));
void TIM4_IRQHandler(void)             __attribute__((weak, alias("Default_Handler")));
void USBWakeUp_IRQHandler(void)        __attribute__((weak, alias("Default_Handler")));
/* IRQ43–46: TIM8 slots share TIM12/13/14 on XL */
...
/* Connectivity line (F105/F107) only */
...
const void* const vector_table[] =
{
    ...
    /* Peripheral IRQs */
    /*
     * IRQ positions 0–18 are identical across all density tiers and the
     * connectivity line.  Divergence starts at IRQ19 (USB/CAN arbitration
     * on LD/MD/HD/XL vs. dedicated CAN1 channels on CL).
     */
...
#if defined(DENSITY_CL)
    /*
     * Connectivity line (Table 61): CAN1 gets three dedicated slots
     * instead of sharing with USB.
     */
    ...
    /* IRQ43-49      */ 0, 0, 0, 0, 0, 0, 0,     /* Reserved 0x00EC–0x0104          */
    ...
    /* IRQ59 0x012C */ DMA2_Channel4_IRQHandler,  /* DMA2 Ch4                       */
    /* IRQ60 0x0130 */ DMA2_Channel5_IRQHandler,  /* DMA2 Ch5                       */
    ...
    /*
     * XL-density (Table 62): IRQ24–26 are multiplexed with TIM9/10/11,
     * IRQ43–45 are multiplexed with TIM12/13/14. No USB wakeup slot
     * (USBWakeUp shares position 42 with the non-XL tables).
     */
    ...
    /* IRQ57 0x0124 */ DMA2_Channel2_IRQHandler,      /* DMA2 Ch2                   */
    /* IRQ58 0x0128 */ DMA2_Channel3_IRQHandler,      /* DMA2 Ch3                   */
    /* IRQ59 0x012C */ DMA2_Channel4_5_IRQHandler,    /* DMA2 Ch4 & Ch5             */

#elif defined(DENSITY_HD)
    /*
     * High-density (Table 63, IRQ43 onward present): TIM1 slots are not
     * multiplexed with TIM9/10/11 (unlike XL), TIM8 slots are not
     * multiplexed with TIM12/13/14 (unlike XL).
     */
    /* IRQ19 0x008C */ USB_HP_CAN_TX_IRQHandler,  /* USB HP / CAN TX                */
    /* IRQ20 0x0090 */ USB_LP_CAN_RX0_IRQHandler, /* USB LP / CAN RX0               */
    /* IRQ21 0x0094 */ CAN_RX1_IRQHandler,        /* CAN RX1                        */
    ...
    /*
     * Low- and medium-density parts end at IRQ42 (USBWakeUp).
     * TIM8, ADC3, FSMC, SDIO, and DMA2 are not present.
     */
    /* IRQ19 0x008C */ USB_HP_CAN_TX_IRQHandler,  /* USB HP / CAN TX                */
    /* IRQ20 0x0090 */ USB_LP_CAN_RX0_IRQHandler, /* USB LP / CAN RX0               */
    /* IRQ21 0x0094 */ CAN_RX1_IRQHandler,        /* CAN RX1                        */
    ...
    /* IRQ28 0x00B0 */ TIM2_IRQHandler,           /* TIM2 global                    */
    /* IRQ29 0x00B4 */ TIM3_IRQHandler,           /* TIM3 global                    */
    /* IRQ30 0x00B8 */ TIM4_IRQHandler,           /* TIM4 global (MD only; NC on LD)*/
    /* IRQ31 0x00BC */ I2C1_EV_IRQHandler,        /* I2C1 event                     */
    /* IRQ32 0x00C0 */ I2C1_ER_IRQHandler,        /* I2C1 error                     */
    /* IRQ33 0x00C4 */ I2C2_EV_IRQHandler,        /* I2C2 event                     */
    /* IRQ34 0x00C8 */ I2C2_ER_IRQHandler,        /* I2C2 error                     */
    ...
    /* IRQ37 0x00D4 */ USART1_IRQHandler,         /* USART1 global                  */
    /* IRQ38 0x00D8 */ USART2_IRQHandler,         /* USART2 global                  */
    /* IRQ39 0x00DC */ USART3_IRQHandler,         /* USART3 global (MD only; NC LD) */
    /* IRQ40 0x00E0 */ EXTI15_10_IRQHandler,      /* EXTI Lines 15:10               */
    /* IRQ41 0x00E4 */ RTCAlarm_IRQHandler,       /* RTC alarm via EXTI             */
    /* IRQ42 0x00E8 */ USBWakeUp_IRQHandler,      /* USB wakeup via EXTI            */
